...
return {
    ...
    -- FJFF Disabled 'modules.commands.protection',
    -- FJFF Disabled 'modules.commands.spectate',
    'modules.commands.search',
    'modules.commands.bot-queue',
    'modules.commands.speed',
    -- FJFF Disabled 'modules.commands.pollution',
    -- FJFF Disabled 'modules.commands.train',
    ...
    -- FJFF Disabled 'modules.commands.artillery',
    -- FJFF Disabled 'modules.commands.surface-clearing',
    ...
    -- FJFF Disabled 'modules.addons.pollution-grading',
    ...
    -- FJFF Disabled 'modules.addons.protection-jail',
    'modules.addons.deconlog',
    -- FJFF Disabled 'modules.addons.nukeprotect',
    -- FJFF Disabled 'modules.addons.inserter',
    -- FJFF Disabled 'modules.addons.miner',
    -- FJFF Disabled 'modules.addons.lawnmower',
    ...
    -- 2.0 Disabled 'modules.gui.warp-list',
    -- 2.0 Disabled 'modules.gui.task-list',
    ...
    -- FJFF Disabled 'modules.gui.surveillance',
