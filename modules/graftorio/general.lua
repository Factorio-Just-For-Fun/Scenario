...
lib.collect_other = function()
	for _, force in pairs(game.forces) do
		...
		other.evolution = {
			...
			evolution_factor_by_pollution = force.get_evolution_factor_by_pollution(),
			evolution_factor_by_time = force.get_evolution_factor_by_time(),
			evolution_factor_by_killing_spawners = force.get_evolution_factor_by_killing_spawners()
		}
